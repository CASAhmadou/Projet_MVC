...
<head>
    ...
    <link rel="stylesheet" href="<?= WEB_PUBLIC."css".DIRECTORY_SEPARATOR."style.liste-questions.css"?>">
...
<body>
    <header id="header">
		<img class="logo" src="<?= WEB_ROOT."img".DIRECTORY_SEPARATOR."logoSA.png"?>">
        <h1 class="titre-tout">Le plaisir de jouer</h1>
    </header>